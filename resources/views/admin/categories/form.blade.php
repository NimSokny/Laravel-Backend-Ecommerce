    ...
    <form action="{{ $action }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <div id="imagePreview" class="mt-3 hidden">
                <img id="previewImg" src="" alt="Image Preview" class="size-32 rounded-lg object-cover border border-slate-200">
                <p class="mt-1 text-xs text-slate-500">Preview</p>
            </div>
            @if(isset($category) && $category->image)
                <div class="mt-3">
                    <img src="{{ asset('storage/' . $category->image) }}" alt="Current Category Image" class="size-24 rounded-lg object-cover border border-slate-200">
